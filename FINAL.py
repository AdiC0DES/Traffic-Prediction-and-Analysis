...
# Load dataset
df = pd.read_csv("C:/Users/Aditya/proj/TPA/updateddataset.csv")
...
print(results_df)
results_df.to_csv("C:/Users/Aditya/proj/TPA/results.csv", index=False)

# Classification Model for Predicting Traffic Level
data = pd.read_csv("C:/Users/Aditya/proj/TPA/updateddataset.csv")
